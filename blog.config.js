...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '歡迎來到 Mr Patrick Academy, 這裏可以接觸到AI最新資訊，學習使用AI幫助您提升效率，實現商業突破',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mr Patrick Academy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Mr Patrick Academy', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mrpatrickacademy.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Mr Patrick Academy, AI, 課程, Mr Patrick', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Mr Patrick Academy', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
